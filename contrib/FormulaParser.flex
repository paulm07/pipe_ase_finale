...
<YYINITIAL>"^"			{return tok(sym.POWER,null);}
...
<YYINITIAL>"\u222B"		{return tok(sym.INTEGRAL,null);}
<YYINITIAL>"\u2202"		{return tok(sym.DIFFERENTIAL,null);}
...
<YYINITIAL>"\u03C4"		{return tok(sym.ID, yytext());}
