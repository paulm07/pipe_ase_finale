...
public class FunctionInterpreter implements FunctionHandler {
  ...
  @Function
  private BigDecimal sin(final BigDecimal pinput) {
    double input = pinput.doubleValue();
    return  new BigDecimal(Math.sin(input));
  }
  @Function
  private BigDecimal cos(final BigDecimal pinput) {
    double input = pinput.doubleValue();
    return  new BigDecimal(Math.cos(input));
  }
  @Function
  private BigDecimal tan(final BigDecimal pinput) {
    double input = pinput.doubleValue();
    return  new BigDecimal(Math.tan(input));
  }


  @Function
  private BigDecimal log(final BigDecimal binput,final BigDecimal pinput) {

    return  new BigDecimal(Math.log(pinput.doubleValue()) / Math.log(binput.doubleValue()));
  }

  @Function
  private BigDecimal pow(final BigDecimal pinput,final BigDecimal einput) {

    return  new BigDecimal(Math.pow(pinput.doubleValue(),einput.doubleValue()));
  }

  @Function
  private BigDecimal exp(final BigDecimal pTerm) {
    return new BigDecimal(Math.exp(pTerm.doubleValue()));
  }
