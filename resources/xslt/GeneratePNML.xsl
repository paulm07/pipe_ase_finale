...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="net/place">
        <xsl:element name="place">
            ...
            <!-- The element DataType is deprecated. May be removed at some point in the future -->
            ...
            <xsl:call-template name="continuous"/>
        </xsl:element>
    </xsl:template>
    ...
    <!-- TODO:: agentnet/datatypes may need to be defined to support datatypes in agent net concept -->
    ...
    <xsl:template name="datatype">
        <xsl:element name="datatype">
            ...
            <xsl:element name="elements-count">
                <xsl:element name="value">
                    <xsl:value-of select="@elements-count"/>
                </xsl:element>
            </xsl:element>
